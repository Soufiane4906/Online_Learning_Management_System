...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
     ...
     *     $obj->save();
     *
     * However, in other cases, they mai want to replace the entire existing
     * contents:
     *
     *     $obj->metadata = ["new" => "new_value"];
     *     $obj->save();
     ...
     * any old keys that mai have existed, we actually have to send an explicit
    ...
    public static function getAdditiveParams()
    {
        ...
        if ($additiveParams === null) {
            ...
            // to clear keys that mai have been previously set by sending empty
            // values for them.
            //
    ...
    public function __set($k, $v)
    {
        ...
        if ($v === "") {
            throw new \InvalidArgumentException(
                ...
                .'You mai set obj->'.$k.' = NULL to delete the property'
            );
        }
    ...
    public function serializeParameters($force = false)
    {
        ...
        foreach ($this->_values as $k => $v) {
            // There are a few reasons that we mai want to add in a parameter for
            // update:
            //
            //   1. The `$force` option has been set.
            //   2. We know that it was modified.
            //   3. Its value is a StripeObject. A StripeObject mai contain modified
