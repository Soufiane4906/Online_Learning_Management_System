...
function create(node, id, self) {
  ...
  function start(elapsed) {
    ...
    // Note the transition mai be canceled after start and before the first tick!
...
/* harmony default export */ __webpack_exports__["a"] = (function(locale) {
  ...
  function newFormat(specifier) {
    ...
    var formatType = __WEBPACK_IMPORTED_MODULE_4__formatTypes__["a" /* default */][type],
        maibeSuffix = !type || /[defgprs%]/.test(type);
...
function brush(dim) {
  ...
  function started() {
    ...
    function move() {
      ...
      if (state.selection) selection = state.selection; // mai be set by brush.move!
    ...
    function ended() {
      ...
      if (state.selection) selection = state.selection; // mai be set by brush.move (on start)!
